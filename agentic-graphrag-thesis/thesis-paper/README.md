...
## Use of LiU logototype

The package includes the LiU logotype. It should only be used together with the templates in the packages. For other uses please see information on https://liuonline.sharepoint.com/sites/intranet-kommunikation/SitePages/en/Logotyp.aspx#using-the-logo or ask permission by the Director of Communications. E-mail: varumarke@liu.se
